...
public class StepActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String clientId = "passi" + getIntent().getStringExtra("user");
        final MqttAndroidClient client =
                new MqttAndroidClient(StepActivity.this, "tcp://" + broker_ip + ":1883",
                        clientId);
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (num_steps.equals("")){
                    Toast.makeText(StepActivity.this, "insert step counter!", Toast.LENGTH_SHORT).show();
                }
                else {
                    try {
            ...
            try {
                ...
                token.setActionCallback(new IMqttActionListener() {
                    ...
                    public void onSuccess(IMqttToken asyncActionToken) {
                        String topic = "passi/" + getIntent().getStringExtra("user");;
