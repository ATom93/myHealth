package com.example.danielemalitesta.transportapp;
...
public class TransportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String clientId = "bici" + getIntent().getStringExtra("user");
        final MqttAndroidClient client =
                new MqttAndroidClient(TransportActivity.this, "tcp://" + broker_ip + ":1883",
                        clientId);
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String km = distance.getText().toString();
                if (km.equals("")){
                    Toast.makeText(TransportActivity.this, "insert distance!", Toast.LENGTH_SHORT).show();
                }
                else {
                    try {
            ...
            try {
                ...
                token.setActionCallback(new IMqttActionListener() {
                    ...
                    public void onSuccess(IMqttToken asyncActionToken) {
                        String topic = "bici/" + getIntent().getStringExtra("user");;
