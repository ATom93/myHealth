...
public class WaterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String clientId = "acqua" + getIntent().getStringExtra("user");
        final MqttAndroidClient client =
                new MqttAndroidClient(WaterActivity.this, "tcp://" + broker_ip + ":1883",
                        clientId);
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String num_steps = counter.getText().toString();
                if (num_steps.equals("")){
                    Toast.makeText(WaterActivity.this, "insert water counter!", Toast.LENGTH_SHORT).show();
                }
                else {
                    try {
            ...
            try {
                ...
                token.setActionCallback(new IMqttActionListener() {
                    ...
                    public void onSuccess(IMqttToken asyncActionToken) {
                        String topic = "acqua/" + getIntent().getStringExtra("user");;
